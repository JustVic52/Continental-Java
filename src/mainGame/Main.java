...
//		game.playGame();		
		...
		//Carta 1
		Carta carta1 = new Carta(11, 2);
		player.getMano().add(carta1);
		player.select(0);
		
		//Carta 2
		Carta carta2 = new Carta(12, 2);
		player.getMano().add(carta2);
		player.select(1);
		
		// Carta 3
		Carta carta3 = new Carta(13, 2);
		player.getMano().add(carta3);
		player.select(2);
		
		//Carta 4
		Carta carta4 = new Carta(1, 2);
		player.getMano().add(carta4);
		player.select(3);
		
		//Carta 5
		Carta carta5 = new Carta(10, 2);
		...
		//Carta 7
		Carta carta7 = new Carta(4, 4);
		player.getMano().add(carta7);
//		player.select(6);
		
		//Carta 8
		Carta carta8 = new Carta(6, 4);
